...
function AIServicePage() {
    var features = [
        {
            icon: <fa_1.FaBrain className="w-6 h-6"/>,
        ...
        {
            icon: <fa_1.FaComments className="w-6 h-6"/>,
        ...
        {
            icon: <fa_1.FaDatabase className="w-6 h-6"/>,
    ...
    return (<div className="min-h-screen">
          ...
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="md:w-1/2 mt-10 md:mt-0">
              <div className="relative h-64 md:h-96 w-full">
                <image_1.default src="/images/ai-service.jpg" alt="Services d'Intelligence Artificielle" fill className="object-cover rounded-xl shadow-lg"/>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {features.map(function (feature, index) { return (<div key={index} className="bg-purple-50 p-6 rounded-xl shadow-md">
          ...
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="md:w-1/2 mt-10 md:mt-0">
              <div className="bg-white p-6 rounded-xl shadow-lg">
                ...
                <link_1.default href="/contact" className="inline-block bg-gradient-to-r from-purple-600 to-indigo-500 text-white font-medium py-3 px-6 rounded-lg hover:from-purple-700 hover:to-indigo-600 transition-all">
                  Contactez-nous
                </link_1.default>
              </div>
            </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-purple-600 to-indigo-500 text-white">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <link_1.default href="/contact" className="inline-block bg-white text-purple-600 font-bold py-3 px-8 rounded-lg shadow-lg hover:bg-gray-100 transition-colors duration-300">
            Demander une Consultation
          </link_1.default>
        </div>
      </section>
