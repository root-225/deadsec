...
function POST(req) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, name, email, user, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    if (!name || !email) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: "Nom et email requis." }, { status: 400 })];
                    }
                    _b.label = 3;
                case 3:
                    _b.trys.push([3, 5, , 6]);
                    return [4 /*yield*/, User_1.default.create({ name: name, email: email })];
                case 4:
                    user = _b.sent();
