...
exports.default = FormationsLandingPage;
...
var formations = [
    {
        ...
        icon: <fa_1.FaLaptopCode className="w-8 h-8 mb-4 text-blue-600 dark:text-blue-400"/> // Add icon
    },
    {
        ...
        icon: <fa_1.FaKeyboard className="w-8 h-8 mb-4 text-blue-600 dark:text-blue-400"/> // Add icon
    },
];
function FormationsLandingPage() {
    return (<div className="pt-24 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10"> {/* Increased gap */}
        {formations.map(function (formation) { return (<link_1.default key={formation.title} href={formation.href} passHref>
            {/* Removed empty lines */}
