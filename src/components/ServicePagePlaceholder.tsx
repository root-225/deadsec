...
export default function ServicePagePlaceholder({
  ...
  const gradientConfigs: Record<string, GradientConfig> = {
    cloud: {
      from: 'from-blue-500',
      to: 'to-cyan-400',
  ...
  const config = gradientConfigs[service];

  return (
    <div
      className={`relative overflow-hidden rounded-xl ${config.bgClass} ${className}`}
      style={{ width, height }}
    >
