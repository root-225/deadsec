    ...
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="bg-red-50 p-6 rounded-xl shadow-md">
          ...
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="md:w-1/2 mt-10 md:mt-0">
              <div className="bg-white p-6 rounded-xl shadow-lg">
                ...
                <Link href="/contact" className="inline-block bg-gradient-to-r from-red-600 to-orange-500 text-white font-medium py-3 px-6 rounded-lg hover:from-red-700 hover:to-orange-600 transition-all">
                  Contactez-nous
                </Link>
              </div>
            </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-red-600 to-orange-500 text-white">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <Link href="/contact" className="inline-block bg-white text-red-600 font-bold py-3 px-8 rounded-lg shadow-lg hover:bg-gray-100 transition-colors duration-300">
            Demander une Consultation
          </Link>
        </div>
      </section>
