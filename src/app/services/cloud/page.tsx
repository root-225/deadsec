...
import { FaCloud, FaServer, FaLock, FaSync, FaChartLine } from 'react-icons/fa';
          ...
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="md:w-1/2 mt-10 md:mt-0">
              <div className="bg-white p-6 rounded-xl shadow-lg">
                ...
                <Link href="/contact" className="inline-block bg-gradient-to-r from-blue-600 to-cyan-500 text-white font-medium py-3 px-6 rounded-lg hover:from-blue-700 hover:to-cyan-600 transition-all">
                  Contactez-nous
                </Link>
              </div>
            </div>
